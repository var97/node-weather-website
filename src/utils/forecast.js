...
const forecast = (latitude, longitude, callback) => {
    ...
    request({url, json: true}, (error, {body})=>{
        if(error){
            ...
            callback(undefined, body.daily.data[0].summary + ' It is currently ' + body.currently.temperature + ' C degrees out. There is a ' + body.currently.precipProbability + '% chance of rain. The timezone is ' + body.timezone + ' .')
        }
    })
}
